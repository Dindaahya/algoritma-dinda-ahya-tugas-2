/* Nama : Dinda ahya
   Npm  : 227064516068
   Tugas kuliah 2 kelompok algoritma
*/
...
switch(pilihmenu){
	case 1:
		//case 1 itu untuk melihat price list yang ada pada toko
		//untuk melihat price list menggunakan cout 
	...
	case 2:
		//case 2 mencari harga barang yang ada di toko
		// untuk mencari harga barang itu menggunakan sequential search, sequential search ntuk menemukan hasil tertentu
		// dalam array 1 dimensi yang memeriksa setiap elemen secara berurutan dari awal sampai akhir hingga elemennya ditemukan atau daftar
		// elemen habi,dan tidak diurutkan
	{
	...
	case 3:	
		// case 3 yaitu untuk memulai order barang 
		// untuk memulai order menggunakan array, array merupakan sebuah tipe data yang berisi kumpulan data atau banyak nilai dengan
		// tipe data yang sama, dengan menggunakan array kita dapat mengetahui berapa jenis barang yang ingin kita beli
	{
		cout << "===== Pricelist Toko Baju Sederhana =====" << endl;
		cout << "1. Baju : Rp. 50.000" << endl;
		cout << "2. Celana : Rp. 100.000" << endl;
	...
	case 4:	
		// case 4 yaitu untuk bayar
		// untuk membayar kita menggunakan if else, yang dimana if else itu tidak hanya digunakan untuk menentukan tindakan apa yang akan diambil
		// sesuai dengan kondisi, tetapi juga digunakan untuk menentukan tindakan apa yang akan diambil/dijalankan jika kondisi tidak sesuai.
		// jika pembayaran dan jumlah total benar maka kode bisa dieksekusi
		// tetapi pembayaran kurang dari total harga maka kode tidak bisa dieksekusi atau "uang anda tidak cukup"
		if(jenis<1){
	...
	case 5:
		// case 5 untuk cetak barang yang diorder
		// untuk mencetak receipt menggunakan if else dan array
		// jika pembayaran lunas maka receipt bisa dicetak
		// tetapi jika pembayaran tidak lunas maka receipt tidak bisa dicetak
		// array untuk menyimpan suatu data dalam satu tempat
		if (lunas!=true){
